programa
{
	...
	funcao menu()
	{
		...
		escreva("\n++++++++++++++++++++++++++++++++++++++++++++++++++++\n")
		escreva("+  1 - Cadastro de Funcionário                     +\n")
		escreva("+  2 - Contra Cheque				   +\n")
		escreva("+  3 - Simulador de Adicional de Horas Extras      +\n")
		escreva("+  4 - Simulador de Adicional Noturno		   +\n")
		escreva("+  5 - Simulador de Adicional por Periculosidade   +\n")
		escreva("+  6 - Simulador de Benefícios de Deposito do FGTS +\n")
		escreva("+  7 - Simulador de Benefícios de Vale-Transporte  +\n")
		escreva("+  8 - Simulador de Cálculo de Férias              +\n")
		escreva("+  9 - Simulador de Descontos de Imposto de Renda  +\n")
		escreva("+  10 - Simulador de Descontos do INSS             +\n")
		escreva("+  11 - Simulador de Multa do FGTS                 +\n")
		escreva("+  12 - Simulador de PIS			   +\n")
		escreva("+  13 - Simulador de Seguro-Desemprego		   +\n")
	...
	{
		real salario_bruto, desconto_inss
		escreva("_______________________________________________________________________\n")
	 	...
	 	leia(salario_bruto)
	 	desconto_inss = calculo_desconto_inss(salario_bruto)
	...
	funcao real calculo_desconto_inss(real salario_bruto)
	{
		...
		senao se(salario_bruto <= faixa_salarial2)
		{
			...
			desconto_2 = 0.09 * (salario_bruto - faixa_salarial) + desconto_1
		...
		senao se(salario_bruto <= faixa_salarial3)
		{
			...
			desconto_3 = 0.12 * (salario_bruto - faixa_salarial2) + desconto_1 + desconto_2
			desconto_3 = mat.arredondar(desconto_3, 2)
			retorne desconto_3
		}	
		senao se(salario_bruto <=  faixa_salarial4)
		{
			desconto_1 = (faixa_salarial * 0.075)
			desconto_2 = 0.09 * (faixa_salarial2 - faixa_salarial)
			desconto_3 = 0.12 * (faixa_salarial3 - faixa_salarial2)
			desconto_4 = 0.14 * (salario_bruto - faixa_salarial3) +  desconto_1 + desconto_2 + desconto_3
	...
	{
		real adicional_ferias, salario_bruto
		...
		adicional_ferias = calculo_adicional_ferias(salario_bruto)
	...
	funcao real calculo_adicional_ferias(real salario_bruto2)
	{
		const real faixa_salarial = 1302.00
		const real faixa_salarial2 =2571.29
		const real faixa_salarial3 =3856.94
		
		real desconto_1, desconto_2, desconto_3, desconto_4, salario_bruto, salario_bruto1
		inteiro dias_de_ferias
		real ir, valor_ferias, ir_ferias, ir_inss, desconto_inss = 0.0

		salario_bruto2 = (salario_bruto2/3) + salario_bruto2

		salario_bruto1 = salario_bruto2
		ir = calculo_imposto_de_renda(salario_bruto1)
		
		salario_bruto = salario_bruto2
		desconto_inss = calculo_desconto_inss(salario_bruto)

		ir_inss = ir + desconto_inss
		valor_ferias = salario_bruto2 - ir_inss
	...
	{
		real salario_bruto, desconto_imposto_de_renda
		...
		desconto_imposto_de_renda = calculo_imposto_de_renda(salario_bruto)
	...
	funcao real calculo_imposto_de_renda(real salario_bruto)
	{
		...
		real ir, salario_bruto2, valor_desconto
		
		salario_bruto2 = salario_bruto
		valor_desconto = calculo_desconto_inss(salario_bruto2)
		salario_bruto = salario_bruto - valor_desconto

		se(salario_bruto < 1903.99)
		{
			ir = 0.0
		}
		senao se(salario_bruto < 2826.66)
		{
			ir = (salario_bruto - faixa_ir1) * 0.075
		}
		senao se(salario_bruto < 3751.06)
		{
			ir = (faixa_ir2 - faixa_ir1) * 0.075
			ir = ir + ((salario_bruto - faixa_ir2) * 0.15)
		}
		senao se(salario_bruto < 4664.69)
		{
			ir = (faixa_ir2 - faixa_ir1) * 0.075
			ir = ir + ((faixa_ir3 - faixa_ir2) * 0.15)
			ir = ir + ((salario_bruto - faixa_ir3) * 0.225)
		}
		senao 
		{
			ir = (faixa_ir2 - faixa_ir1) * 0.075
			...
			ir = ir + ((salario_bruto - faixa_ir4)* 0.275)
		}
	...
	{
		real salario_bruto, desconto_fgts
		...
		desconto_fgts = calculo_desconto_fgts(salario_bruto)
	...
	funcao real calculo_desconto_fgts(real salario_bruto)
	{
		real fgts
	...
	{
		real salario_bruto, calculo_multa_fgts_var_valor_multa
		
		salario_bruto = 0.0
		calculo_multa_fgts_var_valor_multa = calculo_multa_fgts(salario_bruto)
	...
	funcao real calculo_multa_fgts(real salario_bruto)
	{
		real saldo, multa
	...
	{
		real desconto_vale_transporte, salario_bruto
		cadeia sim_nao
		...
		desconto_vale_transporte = calculo_desconto_vale_transporte(salario_bruto)
		desconto_vale_transporte = mat.arredondar(desconto_vale_transporte, 2)
		
		escreva("\nO valor de desconto do vale transporte é de R$ ", desconto_vale_transporte, "\n")
		escreva("______________________________________________________________________\n")
		...
		se(sim_nao == "S")
		{
			se(desconto_vale_transporte > 4 * passagem * 20)
			{
	...
	funcao real calculo_desconto_vale_transporte(real salario_bruto)
	{
	...
	{
		real salario_bruto, adicional_noturno, horas_noturnas
		...
		adicional_noturno = calculo_adicional_noturno(salario_bruto, horas_noturnas)
	...
	funcao real calculo_adicional_noturno(real salario_bruto, real horas_noturnas)
	{
		real salario_descontado, salario_hora, valor_adicional_noturno
		
		valor_adicional_noturno = ( salario_bruto * horas_noturnas) * 0.2
	...
	{
		real valor_adicional_periculosidade, salario_bruto
	...
	{
		real salario_bruto, adicional_horas_extras, horas_extras_trabalhadas
		...
		adicional_horas_extras = calculo_adicional_horas_extras(salario_bruto, horas_extras_trabalhadas)
	...
	funcao real calculo_adicional_horas_extras(real salario_bruto, real horas_extras_trabalhadas)
	{
		real valor_adicional_horas_extras
		
		valor_adicional_horas_extras = (salario_bruto * horas_extras_trabalhadas) * 1.5
 ...
 * 
 * @POSICAO-CURSOR = 263; 
 * @DOBRAMENTO-CODIGO = [9, 14, 24, 45, 76, 143, 168, 185, 210, 257, 284, 308, 336, 381, 408, 418, 441, 456, 512, 523, 553, 563, 590, 599, 628, 637, 733, 807, 851, 916];
 * @PONTOS-DE-PARADA = ;
